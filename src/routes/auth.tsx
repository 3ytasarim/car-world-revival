...
function AuthPage() {
  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-brand-orange px-4">
      <ClientOnly fallback={null}>
        <DotGridBackground color="#DCEDFA" />
      </ClientOnly>
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_center,transparent_0%,rgba(27,58,99,0.45)_100%)]" />

      <div className="relative z-10 w-full max-w-sm rounded-3xl border border-white/10 bg-[#3D6FA8]/90 p-8 shadow-[0_30px_80px_-20px_rgba(19,31,53,0.55)] backdrop-blur-md">
        <div className="flex flex-col items-center text-center">
          <img src={carWorldLogo} alt="Car-World" className="h-14 w-auto" />
