                ...
                >
                  {active && (
                    <>
                      ...
                      <span className={`pointer-events-none absolute -top-[13px] left-1/2 h-1 w-8 -translate-x-1/2 rounded-full ${scrolled ? "bg-[#E8F1FB]" : "bg-[#5088C8]"}`} />
                      <span className={`pointer-events-none absolute -top-[13px] left-1/2 h-4 w-12 -translate-x-1/2 rounded-full blur-md ${scrolled ? "bg-[#E8F1FB]/40" : "bg-[#5088C8]/40"}`} />
                    </>
                  )}
