...
const DEVICE_SPECS: Record<IPhoneModel, Spec> = {
      ...
      <div style={frameBoxStyle}>
        <div style={screenBoxStyle}>
          ...
          {useIsland && finalIslandW > 0 && finalIslandH > 0 && (
            <div
              aria-hidden="true"
              style={{ ...cutoutCommon, top: 10, width: finalIslandW, height: finalIslandH, borderRadius: finalIslandR }}
            />
          )}
          ...
          {!useIsland && useNotch && finalNotchW > 0 && finalNotchH > 0 && (
            <div
              ...
              style={{
                ...
                width: finalNotchW,
                height: finalNotchH,
                borderBottomLeftRadius: finalNotchR,
                borderBottomRightRadius: finalNotchR,
              }}
            />
          )}
